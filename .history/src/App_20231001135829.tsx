...
function App() {
  ...
  return (
    <div className= "w-screen h-screen">
      ...
      <p className='text-gray-400 justify-start text-lg pl-2 mt-8 text-start flex hover:scale-105 duration-300 hover:text-blue-300'>Instructions - This portfolio is a replica of  terminal. You can use it like your local terminal. </p>
